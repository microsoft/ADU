...
#* 2. Moved logs to D:\PdwDiagnostics to be consistent with other diagnostic tools.
...
$Archive="D:\PDWDiagnostics\PDWPublish_XML_Archive\$CurrTIme"
...
Function PDWPublishXMLs
{
	...
	{
		$badInput = $false
		$XMLServer = "\\$pdwReg-ctl01\SQLPDW10\"
		...
		[string]$XMLSourceDir= Read-host "`nXML UNC Source Directory (Leave Blank for \\$pdwReg-CTL01\SQLPDW10)"
